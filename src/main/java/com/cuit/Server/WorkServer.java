...
import com.cuit.Dao.UserDaoImpl;
import com.cuit.Utils.GsonUtils;
import com.cuit.bean.ServerUser;
...
public class WorkServer extends Thread {
    ...
    /**
     * the message to deal with com.cuit.Client's command
     *
     * @param readLine
     */
...
//                System.out.println("");
    ...
    /**
     * send the message to com.cuit.Client
     */
